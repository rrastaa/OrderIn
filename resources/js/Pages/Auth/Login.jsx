...
export default function Login({ errors }) {
    ...
    return (
        <div className="bg-[#0b1329] flex items-center justify-center min-h-screen p-4">
            <div className="bg-white w-full max-w-[1000px] h-[600px] rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-2/5 p-8 flex flex-col justify-center">
                    ...
                    <p className="text-sm text-gray-500 mb-6">
                        Login to keep your business running
                    </p>
                    ...
                    <form onSubmit={submit} className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                required
                                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent transition"
                            />
                        </div>
